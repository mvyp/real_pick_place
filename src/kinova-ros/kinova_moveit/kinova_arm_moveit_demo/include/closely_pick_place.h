#ifndef CLOSELY_PICK_PLACE_H
#define CLOSELY_PICK_PLACE_H
...
namespace kinova
{
    ...
    public:
        ...
        gpd_ros::GraspConfig mygoal;
        int Flag;
        std::vector<double> grasp_scope;
        ...
        gpd_ros::GraspConfig trans_grasp_pose(gpd_ros::GraspConfig);
        void my_pick(const gpd_ros::GraspConfigList &);
        void get_grasp_scope(const gpd_ros::GraspConfig &);
    ...
    private:
        ...
        bool evaluate_cartesian_plan(geometry_msgs::PoseStamped pre_grasp, geometry_msgs::PoseStamped fin_grasp);
